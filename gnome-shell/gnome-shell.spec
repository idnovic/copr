...
Source0:        http://download.gnome.org/sources/gnome-shell/3.32/%{name}-3.32.2.tar.xz
...
* Thu May 09 2019 Yussuf Khalil <dev@pp3345.net> 3.32.1-1.3
- Drop !529 "st: Delay handling of :first/:last-child changes" (regression)
- Rebase to gnome-3-32 @92f1e88e

* Sun May 05 2019 Yussuf Khalil <dev@pp3345.net> 3.32.1-1.2
- Add !524 "Mild performance improvements on style changes" @94995e9c
- Add !136 "Fix and polish the window overlays of the overview" @39c8c9ac
- Add !529 "st: Delay handling of :first/:last-child changes" @46c4cb53
- Rebase to gnome-3-32 @0539efc8

* Wed Apr 17 2019 Yussuf Khalil <dev@pp3345.net> 3.32.1-1.1
- Drop !276 "js/ui: Use captured-event::nonmotion" (needs rebase)
- Drop !470 "st: Round CSS units to the nearest multiple of the scale factor" (upstreamed)
...
- Add !470 "st: Round CSS units to the nearest multiple of the scale factor" @526f7487
- Add !276 "js/ui: Use captured-event::nonmotion" @297a18f2
- Rebase to master @b05683d5
